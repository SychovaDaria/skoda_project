...
class App(tk.Tk):
    ...
    def nactiGUI(self) -> None:
        ...
        # img capture settings
        self.btTriggerSettings = ttk.Button(self.frOvladani, text="Nastavení Akvizice fotek",  command=self.open_trigger_settings, compound=tk.LEFT,width=20, style='TButton')
